...
int main() {
    ...
    if (studentFile == NULL) {
        ...
        // Read and process data from StudentInf.txt file
    ...
    printf("_______numStudents=______________________%d" , numStudents);
...
/**************************************************************/
    ...
    FILE *subjectFile = fopen("SubjectMark.txt", "r");
    if (subjectFile == NULL) {
    ...
    // Read and process data from SubjectMark.txt input file
...
//        float gradePoint = 3; // Setting all subject credit hours to 3
//
...
/// Function to calculate GPA from marks
//calculateGPA(int marks)

/// Function to calculate letter grade from marks
// calculateLetterGrade(int marks)
...
//    Result RESULT[numStudents];
    ...
    printf("_\n _Line 415 studentMarks[numStudents33].marks[3]__ %d \n ", studentMarks[numStudents33].marks[3]);


printf("___Line 417___numStudents33____________________%d\n " , numStudents33);



printf("___Line 421___numStudents_________________%d\n" , numStudents);
...
if (fp != NULL) {
    printf("\n Line 460 Successfully created and opened the file student_grades.txt\n");
...
printf("Line 590 \n Student grades and GPA written to 'student_grades.txt'.\n");
